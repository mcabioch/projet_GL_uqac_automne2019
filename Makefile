...
SOURCES       = src/main.cpp \
		...
		inc/Widgets/WindowTitleBar_Event.cpp moc_MainWindow.cpp \
		moc_DrawScene.cpp \
		moc_GraphScene.cpp \
		moc_Lines.cpp \
		moc_Scene.cpp \
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_DrawScene.cpp moc_GraphScene.cpp moc_Lines.cpp moc_Scene.cpp moc_TableWidget.cpp moc_Widget.cpp moc_Window.cpp moc_WindowButton.cpp moc_WindowTitleBar.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_DrawScene.cpp moc_GraphScene.cpp moc_Lines.cpp moc_Scene.cpp moc_TableWidget.cpp moc_Widget.cpp moc_Window.cpp moc_WindowButton.cpp moc_WindowTitleBar.cpp
moc_MainWindow.cpp: inc/Widgets/Qt.hpp \
		inc/Widgets/QtDefines.hpp \
		inc/Widgets/Widget.hpp \
		inc/Widgets/DrawScene.hpp \
		inc/Widgets/Scene.hpp \
